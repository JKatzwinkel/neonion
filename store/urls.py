...
urlpatterns = [
    ...
    url(r'^(?P<group_pk>.+)/(?P<document_pk>.+)/statements$', views.StatementListView.as_view()),
    url(r'^(?P<group_pk>.+)/(?P<document_pk>.+)/groupedstatements$', views.GroupedStatementsView.as_view()),
]
