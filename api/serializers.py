...
class DocumentSerializer(serializers.ModelSerializer):
    class Meta:
        model = Document
        fields = ('id', 'uri', 'title', 'created', 'updated', 'workinggroup_set', 'concept_set', 'url')
...
class DocumentDetailedSerializer(DocumentSerializer):
    ...
    class Meta:
        model = Document
        fields = ('id', 'uri', 'title', 'created', 'updated', 'attached_file', 'workinggroup_set', 'concept_set', 'url') #'annotation_set_id'
